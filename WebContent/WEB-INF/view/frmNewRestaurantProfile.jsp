				  	...
				  	<div class="tab-content">
					    	<div class="tab-pane active" id="tab1">
					  		...
					  		<ul class="nav nav-pills">
								<li class="active"><a href="<spring:url value=""/>">Informações gerais</a></li>
							  	<li><a href="<spring:url value=""/>">Dados básicos</a></li>
									...
									<div class="row">
										...
										<div class="span7">
											...
											<div class="control-group control-adm">
												<label class="control-label large" for="inputNomeFantasia">Descrição resumida</label>
											    <div class="controls">
											    	<form:textarea path="" rows="3" cssClass="input-xlarge" placeholder="Apresentação do restaurante (máx. 150 caracteres)"/>
											    </div>
											</div>
											<div class="control-group control-adm">
												<label class="control-label large" for="inputNomeFantasia">Descrição completa</label>
											    <div class="controls">
											    	<form:textarea path="" rows="6" ccsClass="input-xlarge" placeholder="Apresentação completa do restaurante (máx. 300 caracteres)"/>
											    </div>
											</div>
											<div class="control-group control-adm">
												<label class="control-label large" for="inputNomeFantasia">Dias e horários de funcionamento</label>
											    <div class="controls">
											    	<textarea rows="2" id="inputNomeFantasia" class="input-xlarge" placeholder="Ex: Segunda a Sexta - 10h00 às 15h00 / Sábados e Domingos - 10h00 às 15h00"></textarea>
											    </div>
											</div>
										</div>
									</div>
